//
//  AdvancedRendererTests.swift
//  MatchaTests
//
//  Advanced tests for renderer functionality including ignored lines and edge cases.
//
...
struct AdvancedRendererTests {
    ...
    func testIgnoredLinesRendering() async throws {
    ...
    func testScrollAreaBoundaries() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
    ...
    func testScrollOperations() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
    ...
    func testLargeContentRendering() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
    ...
    func testRapidContentUpdates() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
    ...
    func testUnicodeRendering() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
    ...
    func testANSIInContent() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
    ...
    func testRendererStatePersistence() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
    ...
    func testRendererKillVsStop() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
    ...
    @Test("Window title edge cases")
    func testWindowTitleEdgeCases() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
    ...
    func testLineDiffingOptimization() async throws {
        let outputBuffer = TestOutputStream()
        let renderer = StandardRenderer(output: outputBuffer, fps: 60)
        await renderer.start()
