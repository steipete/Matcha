//
//  PanicRecoveryTests.swift
//  MatchaTests
//
//  Tests for panic recovery and error handling in Matcha programs.
//
...
struct PanicRecoveryTests {
    ...
    func testPanicRecovery() async throws {
        struct PanicModel: Model {
            ...
            func view() -> String {
                return "Should panic: \(shouldPanic)"
            }
        }
    ...
    @MainActor
    func testPanicNotCaughtWhenDisabled() async throws {
    ...
    @MainActor
    func testCommandErrorHandling() async throws {
    ...
    @MainActor
    func testContextCancellation() async throws {
        let model = TestModel()
        var options = ProgramOptions.default
        options.output = TestOutputStream()
    ...
    @MainActor
    func testInterruptHandling() async throws {
        let model = TestModel()
        var options = ProgramOptions.default
        options.output = TestOutputStream()
    ...
    @MainActor
    func testNoDeadlockOnRapidMessages() async throws {
        let model = TestModel()
        var options = ProgramOptions.default
        options.output = TestOutputStream()
    ...
    @MainActor
    func testNoDeadlockWithConcurrentCommands() async throws {
        struct ConcurrentModel: Model {
            ...
            func view() -> String {
                return "Commands executed: \(commandsExecuted)"
            }
        }
    ...
    @MainActor
    func testTerminalStateRestoredAfterPanic() async throws {
        let model = TestModel()
        var options = ProgramOptions.default
        options.output = TestOutputStream()
    ...
    func testResourceCleanup() async throws {
        struct ResourceModel: Model {
            ...
            func view() -> String {
                return "Resources: \(resourcesAllocated)"
            }
        }
