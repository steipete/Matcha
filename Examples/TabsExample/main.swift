...
//  Matcha
//
//  Demonstrates the Tabs component for tab navigation.
//
...
struct TabsModel: Model {
    ...
    func view() -> String {
        ...
        view += Style().foreground(Color(240)).render("Equal Width: ") +
                (equalWidth ? Style().foreground(.brightGreen).render("ON") : Style().foreground(Color(240)).render("OFF")) +
                "  " +
                Style().foreground(Color(240)).render("Underline: ") +
                (showUnderline ? Style().foreground(.brightGreen).render("ON") : Style().foreground(Color(240)).render("OFF")) + "\n\n"
