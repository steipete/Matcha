...
public struct Help: Sendable {
    ...
    public var keyStyle: Style = Style().foreground(.cyan)
    ...
    public var disabledStyle: Style = Style().faint()
    
    /// Style applied to the main help title
    public var titleStyle: Style = Style().bold()
    
    /// Style applied to group section titles
    public var groupTitleStyle: Style = Style().underline()
