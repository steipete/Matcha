...
public struct Confirmation: Sendable {
    ...
    private func applyBorder(_ content: [String], style: BorderStyle, width: Int) -> [String] {
        ...
        lines
            .append(boxStyle
                .render(chars.topLeft + String(repeating: chars.horizontal, count: width - 2) + chars.topRight)
            )
        ...
        lines
            .append(boxStyle
                .render(chars.bottomLeft + String(repeating: chars.horizontal, count: width - 2) + chars.bottomRight)
            )
